            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <form role="form" method="post" action="#">
                        ...
                        <a href="/sell/admin/examineOk?sellerId=${sellerInfo.sellerId}" type="button" class="btn btn-default btn-primary">审核通过</a>
                        <a href="/sell/admin/examineNot?sellerId=${sellerInfo.sellerId}" type="button" class="btn btn-default btn-danger">审核未通过</a>
                    </form>
                </div>
            </div>
        </div>
