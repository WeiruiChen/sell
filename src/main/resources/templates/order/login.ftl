...
<div class="login">
   <div class="banner">
   <iframe id="frame_banner"  src="banner" height="218" width="100%"  allowtransparency="true" title="test"  scrolling="no" frameborder="0">
   </iframe>
   </div>
   <div class="logmain">
      <h1>&nbsp;</h1>
       <form method="post" action="sellerLogin">
          ...
          <div class="logdv">
            <p class="logzi">&nbsp;</p>
            <a href="/sell/admin/onAdminLogin" class="more">管理员登陆</a>
