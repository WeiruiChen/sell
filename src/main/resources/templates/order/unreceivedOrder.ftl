											...
											<table class="table table-striped table-bordered table-hover">
												...
												<tbody class="tds">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="btns">
                                                            <a class="edit_Btn" href="javascript:void(0)" onclick="detail('${orderDTO.orderId}')" data-toggle="modal" data-target="#orderDetail">详情</a>
                                                            <a class="confirm_Btn" href="/sell/seller/order/finish?orderId=${orderDTO.orderId}" data-toggle="modal" >接单</a>
                                                            <a class="delete_Btn" href="/sell/seller/order/cancel?orderId=${orderDTO.orderId}" data-toggle="modal" >取消</a>
                                                        </td>
                                                    </tr>
													</#list>
