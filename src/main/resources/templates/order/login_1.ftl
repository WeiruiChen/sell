...
<html>
	...
	<body>
		<div class="loginsWrap">
			<h1 style="text-align: center; font-size: 50px; color: darkgreen;">商户后台管理系统</h1>
			<div class="loginWrap">
				...
				<div class="loginW">
					...
					<div class="contWrap">
							...
							<ul>
								...
								<li>
									<div class="mt clearfix">
										<a class="mtL" href="/sell/seller/onSellerRegister">立即注册</a>
										<a class="mtR" href="/sell/admin/modifyPwd">找回密码</a>
									</div>
								</li>
								<li>
                        ...
                        <div class="mt clearfix">
                            <a class="mtR" style="color: blue" href="/sell/admin/onAdminLogin">管理员入口</a>
                        </div>
					</div>
				</div>
			</div>
