...
public class OrderMasterServiceImplTest {
    ...
    @Autowired
    private OrderMasterServiceImpl orderService;

    private final String BUYER_OPENID = "253644582";

    private final String ORDER_ID = "1522116541912200230";

    @Test
    public void create() throws Exception {

        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setBuyerName("CYH");
        orderDTO.setBuyerAddress("湖南大学");
        orderDTO.setBuyerPhone("15084978667");
